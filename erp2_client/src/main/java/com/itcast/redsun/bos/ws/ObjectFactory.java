 ...
 * generated in the com.itcast.redsun.bos.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddWaybillResponse_QNAME = new QName("http://ws.bos.redsun.itcast.com/", "addWaybillResponse");
    private final static QName _WaybilldetailList_QNAME = new QName("http://ws.bos.redsun.itcast.com/", "waybilldetailList");
    private final static QName _WaybilldetailListResponse_QNAME = new QName("http://ws.bos.redsun.itcast.com/", "waybilldetailListResponse");
    private final static QName _AddWaybill_QNAME = new QName("http://ws.bos.redsun.itcast.com/", "addWaybill");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.itcast.redsun.bos.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.com/", name = "addWaybillResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.com/", name = "waybilldetailList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.com/", name = "waybilldetailListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bos.redsun.itcast.com/", name = "addWaybill")
