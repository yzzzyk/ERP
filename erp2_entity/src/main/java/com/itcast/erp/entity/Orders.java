...
public class Orders {	
	 ...
	 * 1=采购订单
	 */
	public static final String TYPR_IN="1";
	/**
	 * 2=销售订单
	 */
	public static final String TYPR_OUT="2";
	...
	private String supplieruuidName;//供应商或客户姓名
	 ...
	 * 9=退货状态
	 */
	public static final String STATE_RETURN="9";
	
	/**
	 * 8=已退货
	 */
	public static final String STATE_RETURN_OK="8";
	...
	public String getSupplieruuidName() {
		return supplieruuidName;
	}
	public void setSupplieruuidName(String supplieruuidName) {
		this.supplieruuidName = supplieruuidName;
	}
